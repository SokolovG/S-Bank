...
Configuration module containing all Django
settings for the DevEvents application.
...
WSGI_APPLICATION = 'DevEvents.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'DevEvents API',
    'DESCRIPTION': 'API for aggregator of conferences and developer meetings',
    'VERSION': '1.0.0',
