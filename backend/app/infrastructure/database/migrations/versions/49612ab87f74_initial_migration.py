...
Revision ID: 49612ab87f74
Revises: 
Create Date: 2025-02-16 01:39:26.306682
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], ondelete='CASCADE', use_alter=True),
    sa.ForeignKeyConstraint(['organizer_id'], ['organizers.id'], ondelete='CASCADE', use_alter=True),
    sa.PrimaryKeyConstraint('organizer_id', 'event_id', 'id')
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], ondelete='CASCADE', use_alter=True),
    sa.ForeignKeyConstraint(['profile_id'], ['profiles.id'], ondelete='CASCADE', use_alter=True),
    sa.PrimaryKeyConstraint('profile_id', 'event_id', 'id')
    )
