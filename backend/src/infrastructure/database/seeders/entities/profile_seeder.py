...
from backend.src.infrastructure.database.models import Profile, Category
from backend.src.infrastructure.database.models.enums import Gender
from backend.src.infrastructure.database.seeders.base_seeder import BaseSeeder
from backend.src.infrastructure.database.seeders.constants import NUM_TEST_DATA
